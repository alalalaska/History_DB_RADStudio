...
protected:
	Virtualtrees::_di_IVTEditLink FRefLink;
...
protected:
	...
	Virtualtrees::PVirtualNode FNode;
	Virtualtrees::Types::TColumnIndex FColumn;
	bool FStopping;
...
public:
	...
	virtual bool __stdcall PrepareEdit(Virtualtrees::TBaseVirtualTree* Tree, Virtualtrees::PVirtualNode Node, Virtualtrees::Types::TColumnIndex Column);
	...
	__property Virtualtrees::Types::TColumnIndex Column = {read=FColumn, nodefault};
	__property Virtualtrees::PVirtualNode Node = {read=FNode};
...
public:
	...
	operator Virtualtrees::_di_IVTEditLink()
	{
		Virtualtrees::_di_IVTEditLink intf;
		this->GetInterface(intf);
		return intf;
	}
	#else
	operator Virtualtrees::IVTEditLink*(void) { return (Virtualtrees::IVTEditLink*)&__IVTEditLink; }
	#endif
