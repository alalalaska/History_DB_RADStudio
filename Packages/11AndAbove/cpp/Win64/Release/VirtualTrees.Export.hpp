...
// (DO NOT EDIT: machine generated header) 'VirtualTrees.Export.pas' rev: 36.00 (Windows)
...
extern DELPHI_PACKAGE unsigned __int64 __fastcall ContentToClipboard(Virtualtrees::TCustomVirtualStringTree* Tree, System::Word Format, Virtualtrees::TVSTTextSourceType Source);
