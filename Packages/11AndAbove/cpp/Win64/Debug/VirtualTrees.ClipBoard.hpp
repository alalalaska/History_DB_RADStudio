...
public:
	__classmethod void __fastcall Add(const System::UnicodeString FormatString, Virtualtrees::TVirtualTreeClass AClass, unsigned Priority, const Winapi::Activex::TFormatEtc &AFormatEtc);
	__classmethod void __fastcall Clear();
	__classmethod void __fastcall EnumerateFormats(Virtualtrees::TVirtualTreeClass TreeClass, Virtualtrees::Types::TFormatEtcArray &Formats, Virtualtrees::TClipboardFormats* const AllowedFormats = (Virtualtrees::TClipboardFormats*)(0x0))/* overload */;
...
extern DELPHI_PACKAGE void __fastcall EnumerateVTClipboardFormats(Virtualtrees::TVirtualTreeClass TreeClass, Virtualtrees::Types::TFormatEtcArray &Formats)/* overload */;
