...
// (DO NOT EDIT: machine generated header) 'VirtualTrees.StyleHooks.pas' rev: 36.00 (Windows)
...
private:
	...
	Winapi::Windows::TPoint __fastcall NCMousePosToClient(const Winapi::Windows::TPoint &P);
...
protected:
	...
	bool __fastcall PointInTreeHeader(const Winapi::Windows::TPoint &P);
...
//-- var, const, procedure ---------------------------------------------------
static _DELPHI_CONST System::Word CM_UPDATE_VCLSTYLE_SCROLLBARS = System::Word(0xb802);
