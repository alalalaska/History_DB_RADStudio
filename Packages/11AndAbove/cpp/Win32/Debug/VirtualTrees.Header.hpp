...
public:
	...
	Winapi::Windows::TRect PaintRectangle;
	Winapi::Windows::TRect TextRectangle;
	bool IsHoverIndex;
	bool IsDownIndex;
	bool IsEnabled;
	...
	Winapi::Windows::TPoint GlyphPos;
	Winapi::Windows::TPoint SortGlyphPos;
...
private:
	...
	Winapi::Windows::TRect FImageRect;
	bool FHasImage;
...
protected:
	...
	virtual void __fastcall ChangeScale(Virtualtrees::Types::TDimension M, Virtualtrees::Types::TDimension D, bool isDpiChange);
...
public:
	...
	virtual Winapi::Windows::TRect __fastcall GetRect();
	__property bool HasImage = {read=FHasImage, nodefault};
	__property Winapi::Windows::TRect ImageRect = {read=FImageRect};
...
private:
	...
	HIDESBASE Virtualtrees::Types::TDimension __fastcall GetCount();
	HIDESBASE TVirtualTreeColumn* __fastcall GetItem(Virtualtrees::Types::TColumnIndex Index);
	bool __fastcall GetNewIndex(const Winapi::Windows::TPoint &P, Virtualtrees::Types::TColumnIndex &OldIndex);
...
protected:
	...
	Virtualtrees::Types::TColumnIndex __fastcall AdjustDownColumn(const Winapi::Windows::TPoint &P);
	bool __fastcall AdjustHoverColumn(const Winapi::Windows::TPoint &P);
	void __fastcall AdjustPosition(TVirtualTreeColumn* Column, unsigned Position);
	bool __fastcall CanSplitterResize(const Winapi::Windows::TPoint &P, Virtualtrees::Types::TColumnIndex Column);
	virtual void __fastcall DoCanSplitterResize(const Winapi::Windows::TPoint &P, Virtualtrees::Types::TColumnIndex Column, bool &Allowed);
	void __fastcall DrawButtonText(HDC DC, System::UnicodeString Caption, const Winapi::Windows::TRect &Bounds, bool Enabled, bool Hot, unsigned DrawFormat, bool WrapCaption);
	void __fastcall FixPositions();
	int __fastcall GetColumnAndBounds(const Winapi::Windows::TPoint &P, Virtualtrees::Types::TDimension &ColumnLeft, Virtualtrees::Types::TDimension &ColumnRight, bool Relative = true);
	DYNAMIC System::Classes::TPersistent* __fastcall GetOwner();
	virtual bool __fastcall HandleClick(const Winapi::Windows::TPoint &P, System::Uitypes::TMouseButton Button, bool Force, bool DblClick);
...
public:
	...
	virtual Virtualtrees::Types::TColumnIndex __fastcall ColumnFromPosition(const Winapi::Windows::TPoint &P, bool Relative = true)/* overload */;
	...
	void __fastcall LoadFromStream(System::Classes::TStream* const Stream, int Version);
	virtual void __fastcall PaintHeader(HDC DC, const Winapi::Windows::TRect &R, Virtualtrees::Types::TDimension HOffset)/* overload */;
	virtual void __fastcall PaintHeader(Vcl::Graphics::TCanvas* TargetCanvas, const Winapi::Windows::TRect &R, const Winapi::Windows::TPoint &Target, Virtualtrees::Types::TDimension RTLOffset = 0x0)/* overload */;
	void __fastcall SaveToStream(System::Classes::TStream* const Stream);
...
protected:
	...
	Winapi::Windows::TPoint FDragStart;
	Winapi::Windows::TPoint FTrackStart;
	Winapi::Windows::TPoint FTrackPoint;
	...
	bool __fastcall CanSplitterResize(const Winapi::Windows::TPoint &P);
	virtual bool __fastcall CanWriteColumns();
	virtual void __fastcall ChangeScale(Virtualtrees::Types::TDimension M, Virtualtrees::Types::TDimension D, bool isDpiChange);
	virtual bool __fastcall DetermineSplitterIndex(const Winapi::Windows::TPoint &P);
	...
	virtual void __fastcall DoCanSplitterResize(const Winapi::Windows::TPoint &P, bool &Allowed);
	virtual bool __fastcall DoColumnWidthDblClickResize(Virtualtrees::Types::TColumnIndex Column, const Winapi::Windows::TPoint &P, System::Classes::TShiftState Shift);
	virtual bool __fastcall DoColumnWidthTracking(Virtualtrees::Types::TColumnIndex Column, System::Classes::TShiftState Shift, Winapi::Windows::TPoint &TrackPoint, const Winapi::Windows::TPoint &P);
	virtual Vcl::Menus::TPopupMenu* __fastcall DoGetPopupMenu(Virtualtrees::Types::TColumnIndex Column, const Winapi::Windows::TPoint &Position);
	virtual bool __fastcall DoHeightTracking(Winapi::Windows::TPoint &P, System::Classes::TShiftState Shift);
	virtual bool __fastcall DoHeightDblClickResize(Winapi::Windows::TPoint &P, System::Classes::TShiftState Shift);
	...
	virtual void __fastcall DragTo(const Winapi::Windows::TPoint &P);
	...
	void __fastcall PrepareDrag(const Winapi::Windows::TPoint &P, const Winapi::Windows::TPoint &Start);
...
public:
	...
	virtual bool __fastcall InHeader(const Winapi::Windows::TPoint &P);
	virtual bool __fastcall InHeaderSplitterArea(const Winapi::Windows::TPoint &P);
