...
// (DO NOT EDIT: machine generated header) 'VirtualTrees.HeaderPopup.pas' rev: 36.00 (Windows)
...
typedef void __fastcall (__closure *TColumnChangeEvent)(System::TObject* const Sender, const Virtualtrees::Types::TColumnIndex Column, bool Visible);
...
protected:
	virtual void __fastcall DoAddHeaderPopupItem(const Virtualtrees::Types::TColumnIndex Column, /* out */ Virtualtrees::Types::TAddPopupItemType &Cmd);
	virtual void __fastcall DoColumnChange(Virtualtrees::Types::TColumnIndex Column, bool Visible);
