...
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TCustomVirtualDrawTree : public Virtualtrees::TBaseVirtualTree
{
	typedef Virtualtrees::TBaseVirtualTree inherited;
	
private:
	Virtualtrees::TVTDrawNodeEvent FOnDrawNode;
	Virtualtrees::TVTGetCellContentMarginEvent FOnGetCellContentMargin;
	Virtualtrees::TVTGetNodeWidthEvent FOnGetNodeWidth;
	
protected:
	virtual System::Types::TPoint __fastcall DoGetCellContentMargin(Virtualtrees::PVirtualNode Node, Virtualtrees::TColumnIndex Column, Virtualtrees::TVTCellContentMarginType CellContentMarginType = (Virtualtrees::TVTCellContentMarginType)(0x0), Virtualtrees::TCanvas* Canvas = (Vcl::Graphics::TCanvas*)(0x0));
	virtual int __fastcall DoGetNodeWidth(Virtualtrees::PVirtualNode Node, Virtualtrees::TColumnIndex Column, Virtualtrees::TCanvas* Canvas = (Vcl::Graphics::TCanvas*)(0x0));
	virtual void __fastcall DoPaintNode(Virtualtrees::TVTPaintInfo &PaintInfo);
	virtual Virtualtrees::TVTHintKind __fastcall GetDefaultHintKind();
	__property Virtualtrees::TVTDrawNodeEvent OnDrawNode = {read=FOnDrawNode, write=FOnDrawNode};
	__property Virtualtrees::TVTGetCellContentMarginEvent OnGetCellContentMargin = {read=FOnGetCellContentMargin, write=FOnGetCellContentMargin};
	__property Virtualtrees::TVTGetNodeWidthEvent OnGetNodeWidth = {read=FOnGetNodeWidth, write=FOnGetNodeWidth};
public:
	/* TBaseVirtualTree.Create */ inline __fastcall virtual TCustomVirtualDrawTree(System::Classes::TComponent* AOwner) : Virtualtrees::TBaseVirtualTree(AOwner) { }
	/* TBaseVirtualTree.Destroy */ inline __fastcall virtual ~TCustomVirtualDrawTree() { }
	
public:
	/* TWinControl.CreateParented */ inline __fastcall TCustomVirtualDrawTree(HWND ParentWindow) : Virtualtrees::TBaseVirtualTree(ParentWindow) { }
...
private:
	Virtualtrees::TVirtualTreeOptions* __fastcall GetOptions();
	HIDESBASE void __fastcall SetOptions(Virtualtrees::TVirtualTreeOptions* const Value);
	
protected:
	virtual Virtualtrees::TTreeOptionsClass __fastcall GetOptionsClass();
...
__published:
	...
	__property Virtualtrees::TVirtualTreeOptions* TreeOptions = {read=GetOptions, write=SetOptions};
