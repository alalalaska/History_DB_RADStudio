...
extern DELPHI_PACKAGE unsigned __fastcall ContentToClipboard(Virtualtrees::TCustomVirtualStringTree* Tree, System::Word Format, Virtualtrees::TVSTTextSourceType Source);
