...
protected:
	...
	HRESULT __fastcall StgMediumIncRef(const Winapi::Activex::TStgMedium &InStgMedium, Winapi::Activex::TStgMedium &OutStgMedium, bool CopyInMedium, const _di_IDataObject DataObject);
...
public:
	__fastcall virtual TVTDataObject(Vcl::Controls::TCustomControl* AOwner, bool ForClipboard);
